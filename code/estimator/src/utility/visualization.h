...
// 双差可视化发布器
extern ros::Publisher pub_secondary_path;
extern ros::Publisher pub_dd_constraints;
extern ros::Publisher pub_satellite_markers;
extern ros::Publisher pub_dd_info_text;
extern nav_msgs::Path secondary_gnss_path;
